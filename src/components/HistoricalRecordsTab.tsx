    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      >
        <div className="flex items-center gap-2 mb-4 sm:mb-6">
          ...
          <h2 className="text-base sm:text-lg text-white/90">Select Date Range</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="space-y-2">
            <Label htmlFor="startDate" className="text-xs uppercase tracking-wider text-white/40">Start Date & Time</Label>
            <Input
              id="startDate"
              type="text"
              value={startDate}
            ...
            />
            <p className="text-xs text-white/30">Format: YYYY-MM-DDTHH:MM:SS-05:00</p>
          </div>

          <div className="space-y-2">
            <Label htmlFor="endDate" className="text-xs uppercase tracking-wider text-white/40">End Date & Time</Label>
            <Input
              id="endDate"
              type="text"
              value={endDate}
        ...
        <div className="mt-6 sm:mt-8">
          ...
          >
            ...
            <span className="truncate">Fetch Historical Data</span>
          </Button>
        </div>
      </motion.div>
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          >
            <div className="relative overflow-hidden rounded-xl border border-cyan-500/20 bg-cyan-500/5 backdrop-blur-sm p-4 sm:p-5 md:p-6 shadow-lg shadow-cyan-500/10">
              <div className="relative z-10">
                <div className="text-[10px] sm:text-xs uppercase tracking-wider text-white/40 mb-2 sm:mb-3">Total Sessions</div>
            ...
            <div className="relative overflow-hidden rounded-xl border border-blue-500/20 bg-blue-500/5 backdrop-blur-sm p-4 sm:p-5 md:p-6 shadow-lg shadow-blue-500/10">
              <div className="relative z-10">
                <div className="text-[10px] sm:text-xs uppercase tracking-wider text-white/40 mb-2 sm:mb-3">Avg PERCLOS</div>
            ...
            <div className="relative overflow-hidden rounded-xl border border-indigo-500/20 bg-indigo-500/5 backdrop-blur-sm p-4 sm:p-5 md:p-6 shadow-lg shadow-indigo-500/10">
              <div className="relative z-10">
                <div className="text-[10px] sm:text-xs uppercase tracking-wider text-white/40 mb-2 sm:mb-3">Avg Blinks</div>
                <div className="text-2xl sm:text-3xl tabular-nums text-indigo-400">{historicalData.avgBlinks}</div>
                <div className="text-xs text-white/30 mt-1 sm:mt-1.5">per minute</div>
              </div>
            ...
            <div className="relative overflow-hidden rounded-xl border border-purple-500/20 bg-purple-500/5 backdrop-blur-sm p-4 sm:p-5 md:p-6 shadow-lg shadow-purple-500/10">
              <div className="relative z-10">
                <div className="text-[10px] sm:text-xs uppercase tracking-wider text-white/40 mb-2 sm:mb-3">Avg Yawns</div>
          ...
          >
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              ...
              <h3 className="text-base sm:text-lg text-white/90">State Distribution</h3>
            </div>
      ...
      {!showData && (
        ...
        >
          ...
          <p className="text-white/40 text-sm sm:text-base md:text-lg px-4">Select a date range and click "Fetch Historical Data"</p>
        </motion.div>
      )}
    </div>
  );
